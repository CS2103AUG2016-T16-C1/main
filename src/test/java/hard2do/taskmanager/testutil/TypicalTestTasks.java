...
public class TypicalTestTasks {
    ...
    public TypicalTestTasks(){
        try {
            ...
            family = new TaskBuilder().withContent("Family Event").withDate("02-11-2016").withEndDate("03-11-2016").withTime("12:00").withEndTime("13:00").withDuration(null).withTags("love").build();
            ...
            appointment = new TaskBuilder().withContent("Have Appointment").withDate("12-01-2016").withEndDate("13-01-2016").withTime("01:00").withEndTime("03:00").withDuration(null).withTags("early").build();
